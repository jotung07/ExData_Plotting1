...
# Plot the line with the necessary annotations and format
with(df, plot(fulltime, Global_active_power, type = "l", xlab = '', ylab = 'Global Active Power (kilowatts)'))
# Close the device graphic manager
dev.off()